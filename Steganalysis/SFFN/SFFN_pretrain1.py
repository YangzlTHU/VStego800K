...
# -*-coding:utf-8 -*-
'''
Implementation of SFFN Method for VoIP Streams
-------------
Based on paper:
...
class MODEL(nn.Module):
    def __init__(self, opt):
        ...
        self.params = list(self.rnn1.parameters()) + list(self.cls1.parameters())
        self.params_other = list(self.rnn2.parameters()) + list(self.cls2.parameters()) + list(
    ...
    def state_dict(self):
        state_dict = [self.rnn1.state_dict(), self.cls1.state_dict()]
        return state_dict
...
def get_loaders(opt):
    ...
    # train tensor
    x_train = np.concatenate((train_positive, train_negative), axis=0)  # 数组拼接
...
if __name__ == '__main__':
    ...
    result_path = os.path.join(result_path, "rnn1")
    if not os.path.exists(result_path):
        os.mkdir(result_path)
